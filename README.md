...
> **[v1.0.0-dev.3](https://github.com/DembaDiack/Stremio/releases/tag/v1.0.0-dev.3)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;4 patches total
<details open>
<summary>📦 Stremio Android TV&nbsp;&nbsp;•&nbsp;&nbsp;4 patches</summary>
<br>
...
| [Force stereo downmix with center boost](#force-stereo-downmix-with-center-boost) | Downmixes multichannel audio to stereo and boosts the center channel for clearer dialogue on 2.0 speakers. Applies to ExoPlayer and libVLC. |  |
